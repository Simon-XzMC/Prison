...
public class ConfigManager {
    ...
    public void setupPlayers() {
        ...
        if (!this.playersfile.exists())
            try {
                ...
                Bukkit.getServer().getConsoleSender().sendMessage(ChatColor.RED + "Coudln't create players.yml file");
            }
        this.playerscfg = YamlConfiguration.loadConfiguration(this.playersfile);
        Bukkit.getServer().getConsoleSender().sendMessage(ChatColor.GREEN + "players.yml file has been created");
    }
    ...
    public void savePlayers() {
        try {
            ...
            Bukkit.getServer().getConsoleSender().sendMessage(ChatColor.RED + "Coudln't save players.yml");
        }
    }
